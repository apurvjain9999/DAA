...
int minDist(int dist[], int sptSet[], int V) //To find vetex with min distance value from set of vertices 
...
{ 
	...
	for (int i = 0; i < V; i++) 
    {
		dist[i] = INT_MAX;  //initialize with maximum value (infinite)
        sptSet[i] = 0; 
    }   
